          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">
                ...
                data-toggle="modal" 
                data-target="#baru">Galery Baru</button>
              </li>
            </ol>
          </div>
        </div>
            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="row mb-3">
                   <a href="{{ Storage::url($item->photo) }}" download="photo" class="btn btn-primary mr-3" onclick="return confirm('Apakah mau didownload')">
                    <span class="fas fa-download">
                    </span>
                  </a>
                  </div>
                  <div class="row mb-3">
                    <a href="#" id=""  class="btn btn-warning mr-4 edit" 
                    data-toggle='modal'
